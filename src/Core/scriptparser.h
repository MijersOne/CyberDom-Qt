...
public:
    ...
    void setTimeVariable(const QString &name, const QVariant &value);
    QVariant getTimeVariable(const QString &name) const;
    void removeTimeVariable(const QString &name);
